...
```
/polyguard-design:audit <path>   # Audit specific file/directory
/polyguard-design:audit          # Audit common UI paths
```
...
2. Run /polyguard-design:extract -> create system from existing code
```
