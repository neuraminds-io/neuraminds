...
```
/polyguard-design:extract          # Extract from common UI paths
/polyguard-design:extract <path>   # Extract from specific directory
```
...
Create .design-system/system.md with these? (y/n/customize)
```
